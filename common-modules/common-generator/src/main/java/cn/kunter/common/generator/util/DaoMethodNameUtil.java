...
public class DaoMethodNameUtil {
    ...
    /** 批量插入数据 */
    private static final String INSERTLIST = "insertBatch";
    /** 插入数据（为null的不插入） */
    ...
    /** 根据主键查询数据 */
    private static final String SELECTBYPRIMARYKEY = "selectById";
    /** 根据主键修改数据 */
    private static final String UPDATEBYPRIMARYKEY = "updateByPrimaryKey";
    /** 根据主键修改数据（为null的不修改） */
    private static final String UPDATEBYPRIMARYKEYSELECTIVE = "updateById";
    /** 根据主键删除数据 */
    private static final String DELETEBYPRIMARYKEY = "deleteById";
     ...
     * @author 阳自然
     */
    public static String getInsertBatch(boolean physical) {
     ...
     * @author 阳自然
     */
    public static String getSelectById(boolean physical) {
