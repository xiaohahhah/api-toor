...
public class PackageHolder {
    ...
    private final static String PACKAGES_MODEL = PropertyHolder.getConfigProperty("package")+".model";
...
//        return getPackage(tableName).append("module").toString();
    }
    ...
    public static String getDaoPackage(String tableName) {
        ...
        return getPackage(tableName).append("mappers").toString();
    }
